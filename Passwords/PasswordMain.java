...
public class PasswordMain extends BorderPane
{
	...
	/**
	 * Main Class for list of password requirements when entered
	 */
	...
	public PasswordMain() 
	{
		...
		instruction3Label = new Label("\t2.  Must contain at least one numeric charcter");
		instruction4Label = new Label("\t3.  Must contain at least one upper case alpha character");
		instruction5Label = new Label("\t4.  Must contain at least one lower case alpha character");
